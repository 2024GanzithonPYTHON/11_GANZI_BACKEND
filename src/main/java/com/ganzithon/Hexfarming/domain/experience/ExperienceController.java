...
import com.ganzithon.Hexfarming.domain.experience.dto.fromClient.GetExperiencesClientDto;
...
public class ExperienceController {
    ...
    public List<ExperienceServerDto> getExperiences(@RequestBody GetExperiencesClientDto dto) {
        return experienceService.getExperiences(dto.userId());
    }
}
